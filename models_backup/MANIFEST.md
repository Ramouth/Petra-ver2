...
|---|---|---|---|---|
| `drawness_full_natural_init.best.pt` | petra-drawness | **CHAMPION** | `~/Petra-ver2/models/drawness_full_natural_init/best.pt` | BCE λ=1.0 + draw-reg + drawness curriculum, init `2021_06_all`, lr 3e-4, 20 epochs |
...
**petra-drawness — `drawness_full_natural_init.best.pt`**
- PoC battery: centroid AUC 0.664, **PC1 PASS 0.666**, logreg 0.665, d=+0.62
- Drawness gates: **4/4** (KR vs KR 0.844 ✓ / KNN vs K 0.756 ✓ / Sicilian 0.020 ✓ / KQ vs K 0.022 ✓)
- Win·draw cosine (probe, strict): −0.582 (project best)
- Effective rank: 23.1
- Top1: 0.197
- ELO H2H vs natural: 39.8% wr (−72 ELO; expected per the fork)
