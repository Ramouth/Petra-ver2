#!/bin/bash
set -euo pipefail
#BSUB -J poc_eval_drawness_full_natural_init_dr03
#BSUB -q hpc
#BSUB -n 4
#BSUB -R "rusage[mem=4GB]"
#BSUB -W 0:30
#BSUB -o /zhome/81/b/206091/logs/poc_eval_drawness_full_natural_init_dr03_%J.out
#BSUB -e /zhome/81/b/206091/logs/poc_eval_drawness_full_natural_init_dr03_%J.err
