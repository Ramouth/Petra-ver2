#!/bin/bash
#BSUB -J eval_phase15_mid_no_endgame
#BSUB -q hpc
#BSUB -n 16
#BSUB -R "rusage[mem=2GB]"
#BSUB -W 6:00
#BSUB -o /zhome/81/b/206091/logs/eval_phase15_mid_no_endgame_%J.out
#BSUB -e /zhome/81/b/206091/logs/eval_phase15_mid_no_endgame_%J.err

#   bsub < jobs/eval_phase15_mid_no_endgame.sh
...
echo "=== Eval Phase 1.5: mid_no_endgame ==="
echo "Model:         ${MODEL}"
...
echo
echo "=== Done: eval_phase15_mid_no_endgame ==="
