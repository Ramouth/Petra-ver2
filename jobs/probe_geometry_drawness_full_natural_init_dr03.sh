#!/bin/bash
set -euo pipefail
#BSUB -J probe_geometry_drawness_full_natural_init_dr03
#BSUB -q hpc
#BSUB -n 1
#BSUB -R "rusage[mem=8GB]"
#BSUB -W 0:30
#BSUB -o /zhome/81/b/206091/logs/probe_geometry_drawness_full_natural_init_dr03_%J.out
#BSUB -e /zhome/81/b/206091/logs/probe_geometry_drawness_full_natural_init_dr03_%J.err
