#!/bin/bash
#BSUB -J eval_phase15_mid_full
#BSUB -q hpc
#BSUB -n 16
#BSUB -R "rusage[mem=2GB]"
#BSUB -W 6:00
#BSUB -o /zhome/81/b/206091/logs/eval_phase15_mid_full_%J.out
#BSUB -e /zhome/81/b/206091/logs/eval_phase15_mid_full_%J.err

#   bsub < jobs/eval_phase15_mid_full.sh

BLACKHOLE="/dtu/blackhole/0b/206091"
HOME_DIR="/zhome/81/b/206091"
SRC="${HOME_DIR}/Petra-ver2/src"

MODEL="${HOME_DIR}/Petra-ver2/models/phase15_mid_full/best.pt"
BASELINE="${HOME_DIR}/Petra-ver2/models/feb_sf/best.pt"
PROBE_DATASET="${BLACKHOLE}/dataset_2021_06_mid_sf18.pt"

echo "=== Eval Phase 1.5: mid_full ==="
echo "Model:         ${MODEL}"
...
echo
echo "=== Done: eval_phase15_mid_full ==="
